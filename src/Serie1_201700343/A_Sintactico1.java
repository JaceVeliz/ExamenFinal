      ...
      switch (CUP$A_Sintactico1$act_num)
		...
		RESULT = start_val;
          ...
          case 1: // INICIO ::= Lista Inicio2 
            {
              Object RESULT =null;
		int bleft = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-1)).left;
		int bright = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-1)).right;
		String b = (String)((java_cup.runtime.Symbol) CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-1)).value;
		int aleft = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()).left;
		int aright = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()).right;
		String a = (String)((java_cup.runtime.Symbol) CUP$A_Sintactico1$stack.peek()).value;
		resultado=b+a;
              CUP$A_Sintactico1$result = parser.getSymbolFactory().newSymbol("INICIO",0, ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-1)), ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), RESULT);
            }
          return CUP$A_Sintactico1$result;
          ...
          case 2: // Inicio2 ::= puntoyc Lista Inicio2 
            {
              String RESULT =null;
		int aleft = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-1)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-1)).right;
		String a = (String)((java_cup.runtime.Symbol) CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-1)).value;
		int bleft = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()).left;
		int bright = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()).right;
		String b = (String)((java_cup.runtime.Symbol) CUP$A_Sintactico1$stack.peek()).value;
		String ope=";"+a+b;
RESULT=ope;
              CUP$A_Sintactico1$result = parser.getSymbolFactory().newSymbol("Inicio2",1, ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-2)), ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), RESULT);
            }
          return CUP$A_Sintactico1$result;
          ...
          case 3: // Inicio2 ::= 
            {
              ...
              CUP$A_Sintactico1$result = parser.getSymbolFactory().newSymbol("Inicio2",1, ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), RESULT);
            }
          return CUP$A_Sintactico1$result;
		...
		String ope=a+b;
RESULT=ope;
              CUP$A_Sintactico1$result = parser.getSymbolFactory().newSymbol("Lista",2, ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-1)), ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), RESULT);
            }
          return CUP$A_Sintactico1$result;
		...
		String ope=","+a;
RESULT=ope;
              CUP$A_Sintactico1$result = parser.getSymbolFactory().newSymbol("Lista2",3, ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-2)), ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), RESULT);
            }
          return CUP$A_Sintactico1$result;
          ...
          case 6: // Lista2 ::= 
            {
              ...
              CUP$A_Sintactico1$result = parser.getSymbolFactory().newSymbol("Lista2",3, ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), RESULT);
            }
          return CUP$A_Sintactico1$result;
          ...
          case 7: // Expresion ::= Expresion mas Expresion 
            {
              String RESULT =null;
		int Ex1left = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-2)).left;
		int Ex1right = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-2)).right;
		String Ex1 = (String)((java_cup.runtime.Symbol) CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-2)).value;
		int Ex2left = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()).left;
		int Ex2right = ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()).right;
		String Ex2 = (String)((java_cup.runtime.Symbol) CUP$A_Sintactico1$stack.peek()).value;
		String datos="";
...
datos=Ex1+Ex2+"+";
              ...
              CUP$A_Sintactico1$result = parser.getSymbolFactory().newSymbol("Expresion",4, ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.elementAt(CUP$A_Sintactico1$top-2)), ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), RESULT);
            }
          return CUP$A_Sintactico1$result;
...
datos=Ex1+Ex2+"/";
		...
		String a = (String)((java_cup.runtime.Symbol) CUP$A_Sintactico1$stack.peek()).value;
		 String nuevo=a;
                        RESULT=nuevo;
              CUP$A_Sintactico1$result = parser.getSymbolFactory().newSymbol("Expresion",4, ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), ((java_cup.runtime.Symbol)CUP$A_Sintactico1$stack.peek()), RESULT);
            }
          return CUP$A_Sintactico1$result;
